...
from wagtail.core.blocks import BlockQuoteBlock, CharBlock, TextBlock
...
class Event(AbstractEvent):
    ...
    image = models.ForeignKey(
        get_image_model_path(), null=True, blank=True, on_delete=models.SET_NULL, related_name="+"
    )
    ...
    body = StreamField(
        [
            ...
            (
                "image",
                ImageChooserBlock(required=False, label="Image", help_text="Add images to describe the event series."),
            ),
    ...
    content_panels = (
        Page.content_panels
        + [MultiFieldPanel([FieldPanel("description"), ImageChooserPanel("image")], heading="Event Description")]
